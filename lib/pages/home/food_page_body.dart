...
class _FoodPageBodyState extends State<FoodPageBody> {
  ...
  void initState() {
    ...
    pageController.addListener(() {
      setState(() {
        ...
        // print("Page Valur is : " + _currPageValue.toString());
      });
    });
  }
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        //slider section
        GetBuilder<PopularProductController>(builder: (pupolarProducts) {
          return pupolarProducts.isLoaded
              ? Container(
                  height: Dimensions.pageView,
                  child: PageView.builder(
                      controller: pageController,
                      itemCount: pupolarProducts.popularProductList.length,
                      itemBuilder: (context, position) {
                        return _buildPageItem(position,
                            pupolarProducts.popularProductList[position]);
                      }),
                )
        ...
        GetBuilder<PopularProductController>(builder: (pupolarProducts) {
          return DotsIndicator(
            dotsCount: pupolarProducts.popularProductList.isEmpty
                ? 1
                : pupolarProducts.popularProductList.length,
